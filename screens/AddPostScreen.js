...
const AddPostScreen = () => {
  ...
  const uploadImage = async () => {
    ...
    //başka değer atayabilmek için let ile tanımladık.
    ...
    const storageRef = storage().ref(`photos/${filename}`); // photos klasörü içine oluşturmus olduk artık yüklenen fotoları
